...
void free_deepseek4_weights(DeepSeek4Weights & w) {
    ...
    // Drop GQH header registry entries while the tensors are still valid, BEFORE
    // ggml_free destroys them: the registry is keyed by data pointer and resolves by
